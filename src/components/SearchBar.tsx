      ...
      {open && (query.length >= 2) && (
        <div className="absolute z-50 w-full mt-1 bg-zinc-800 border border-zinc-700 rounded-lg shadow-xl max-h-80 overflow-y-auto">
          ...
          {results.map((r) => {
            ...
            const picking = pickerId === r.id;
            return (
              <div key={r.id} className="border-b border-zinc-700/50 last:border-0">
                <div className="flex items-center justify-between px-4 py-2.5 hover:bg-zinc-700/50">
                    ...
                    <div className="ml-3 flex items-center shrink-0">
                      ...
                      {(
                        <button
                          ...
                          className="px-1.5 py-1 rounded-r border-l border-blue-500/60 bg-blue-600 hover:bg-blue-500 text-white cursor-pointer transition-colors"
                        >
                    ...
                    <div className="space-y-0.5">
                      {groups.map((g) => (
                        <button
                          ...
                          className="w-full flex items-center gap-2 px-1 py-1 text-left text-xs text-zinc-200 hover:bg-zinc-700/40 rounded cursor-pointer"
                        >
