...
export default function NotificationBell({ notifications, onOpen, onClear }: NotificationBellProps) {
  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      {open && (
        <div className="fixed inset-x-2 top-14 sm:inset-x-auto sm:absolute sm:right-0 sm:top-auto z-50 sm:mt-1 sm:w-80 sm:max-w-[calc(100vw-1.5rem)] bg-zinc-800 border border-zinc-700 rounded-lg shadow-xl overflow-hidden">
