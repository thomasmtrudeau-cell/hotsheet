...
export async function GET(request: NextRequest) {
  try {
    ...
    const list = await getCallupList(date, days, sheetId);
    ...
    const out = premium ? list : list.map((c) => ({ ...c, war: undefined, peakWrcPlus: undefined, era20: undefined, speed: undefined, power: undefined, dual: undefined, def: undefined, presentValue: undefined, age: undefined, hr: undefined, sb: undefined, curWrcPlus: undefined, curEra20: undefined, level: undefined, marketBaseline: undefined }));
